...
class SalaryItem(models.Model):
    ...
    classification = models.CharField(_("classification"), max_length=const.DB_CHAR_CODE_2,
                                      choices=const.get_value_list('S048'), default='10')
    plus_or_minus = models.CharField(_("plus or minus"), max_length=const.DB_CHAR_CODE_2,
                                     choices=const.get_value_list('S049'), default='+')
...
class Entry(generic.BO):
    ...
    probation_months = models.CharField(_("probation months"), max_length=2, default='3',
                                        choices=const.get_value_list('S047'))
