        ...
        if obj and obj.po:
            ...
            for item in po_items:
                try:
                    ...
                    InItem.objects.create(warehouse=obj.warehouse, material=item.material, measure=item.measure,
                                          prop='+',
                                          po_item=item, master=obj, cnt=item.left_cnt, price=pp, batch=obj.batch,
                                          source=obj.code)
