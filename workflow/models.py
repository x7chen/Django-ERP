...
class Node(models.Model):
    ...
    next_user_handler = models.CharField(_('next user handler'), blank=True, null=True,
                                         max_length=const.DB_CHAR_NAME_40)
    next_node_handler = models.CharField(_('next node handler'), blank=True, null=True,
                                         max_length=const.DB_CHAR_NAME_40)
